...
class ModelPriceConfigCreateRequest(BaseModel):
    ...
    image_size_label: Optional[str] = Field(None, max_length=64, description="图片尺寸显示名称，例如 1024x1024（正方形）")
    ...
    aspect_ratio_label: Optional[str] = Field(None, max_length=64, description="宽高比显示名称，例如 1:1（正方形）")
...
class ModelPriceConfigDetailResponse(BaseModel):
    ...
    image_size_label: Optional[str] = Field(None, description="图片尺寸显示名称")
    image_count: int = Field(..., description="生成图片数量")
    aspect_ratio: Optional[str] = Field(None, description="宽高比")
    aspect_ratio_label: Optional[str] = Field(None, description="宽高比显示名称")
