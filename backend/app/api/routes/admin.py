...
def get_model_price_configs(
    ...
    items = [
        ModelPriceConfigDetailResponse(
            ...
            image_size_label=item.image_size_label,
            image_count=item.image_count,
            aspect_ratio=item.aspect_ratio,
            aspect_ratio_label=item.aspect_ratio_label,
...
def create_model_price_config(
    ...
    response_data = ModelPriceConfigDetailResponse(
        ...
        image_size_label=config.image_size_label,
        image_count=config.image_count,
        aspect_ratio=config.aspect_ratio,
        aspect_ratio_label=config.aspect_ratio_label,
